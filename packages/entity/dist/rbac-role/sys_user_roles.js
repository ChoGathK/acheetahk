...
let SysUserRoles = class SysUserRoles extends entity_common_1.CommonEntity {
};
__decorate([
...
__decorate([
    typeorm_1.ManyToOne(() => sys_role_1.SysRole, (role) => role.map),
    __metadata("design:type", sys_role_1.SysRole)
], SysUserRoles.prototype, "role", void 0);
__decorate([
    typeorm_1.ManyToOne(() => sys_user_1.SysUser, (user) => user.map),
    __metadata("design:type", sys_user_1.SysUser)
], SysUserRoles.prototype, "user", void 0);
SysUserRoles = __decorate([
    typeorm_1.Entity('sys_user_roles')
], SysUserRoles);
